		...
		<form class="form-horizontal" style="margin-top:5px;" >
			 <div class="form-group">
			   ...
			   <div class="form-group">
			    ...
			    <div class="col-sm-6">
			      <input type="password" class="form-control" id="inputPassword3" name="user.password" placeholder="请输入密码">
			    </div>
			  </div>
			   <div class="form-group">
			    <label for="confirmpwd" class="col-sm-2 control-label">确认密码</label>
			    <div class="col-sm-6">
			      <input type="password" class="form-control" id="confirmpwd" name="user.confirmpassword" placeholder="请输入确认密码">
			    </div>
			  </div>
			  <div class="form-group">
			 ...
			 <div class="form-group">
			  ...
			  <input type="radio" name="inlineRadioOptions" id="inlineRadio1" dirname="user.sex"   value="option1"> 男
			</label>
			<label class="radio-inline">
			  <input type="radio" name="inlineRadioOptions" id="inlineRadio2" dirname="user.sex"  value="option2"> 女
			</label>
			</div>
			  </div>		
			  <div class="form-group">
			    ...
			    <div class="col-sm-6">
			      <input type="date" class="form-control" name="user.brithdate"  >
			    </div>
			  </div>
			  ...
			  <div class="form-group">
			    <div class="col-sm-offset-2 col-sm-10">
			      <input type="submit"  width="100" value="注册" name="submit"  onclick="regist()" border="0"
